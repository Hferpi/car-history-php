...
Route::middleware('authcheck')->group(function () {
    ...
    Route::prefix('vehicles')->group(function () {
        Route::get('/garage', [VehicleController::class, 'garage'])->name('vehicles.garage');
        ...
        //Reparacion
        Route::post('/{vehicle}/repairs', [VehicleRepairController::class, 'store'])->name('repairs.store');
        Route::get('/vehicles/{vehicle}/repair', fn($vehicle) => view('vehicles.repair', compact('vehicle')))->name('vehicles.repair');
    });
});
